...
const bubble_sort_js_1 = __importDefault(require("../algorithms/bubble_sort.js"));
const selection_sort_js_1 = __importDefault(require("../algorithms/selection_sort.js"));
const insertion_sort_js_1 = __importDefault(require("../algorithms/insertion_sort.js"));
...
let list = Array.from({ length: parseInt(bars_number_counter.value) }, () => Math.floor((Math.random() * max_list_number) + 2));
let item = null;
...
launcher.addEventListener("click", () => {
    ...
    switch (inputValue) {
        case "bubbleSort":
            (0, bubble_sort_js_1.default)(list, bars, animation_delay_counter.value);
            algoName.textContent = inputValue;
            break;
        case "insertionSort":
            (0, insertion_sort_js_1.default)(list, bars, animation_delay_counter.value);
            algoName.textContent = inputValue;
            break;
        case "selectionSort":
            (0, selection_sort_js_1.default)(list, bars, animation_delay_counter.value);
            algoName.textContent = inputValue;
            break;
        default:
            break;
